...
class NotesWidget(BaseWidget):
    ...
    def _create_header(self, layout: QVBoxLayout):
        ...
        set_tooltip(self.float_btn, "悬浮窗口")
    ...
    def _show_menu(self) -> None:
        ...
        self.note_input.setPlaceholderText("在此输入便签...")
        ...
        # Add Note button
        self.add_button = QPushButton("添加便签")
