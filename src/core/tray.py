...
class SystemTrayManager(QSystemTrayIcon):
    ...
    def _show_context_menu(self):
        ...
        try:
            ...
            add_item(hmenu, "重载 YASB", self._reload_application)
            add_sep(hmenu)
            ...
            if self.komorebi_enabled and self.is_wm_installed("komorebi"):
                ...
                if self.komorebi_reload:
                    add_item(km_sub, "重载 Komorebi", lambda: self._run_wm_command("Komorebi", self.komorebi_reload))
            ...
            if self.glazewm_enabled and self.is_wm_installed("glazewm"):
                ...
                if self.glazewm_reload:
                    add_item(gw_sub, "重载 GlazeWM", lambda: self._run_wm_command("Glazewm", self.glazewm_reload))
    ...
    def _reload_application(self):
        reload_application("正在从托盘重载应用...")

    def _exit_application(self):
        exit_application("正在从托盘退出应用...")
